...
| `plugins.installDefault`           | Boolean        | `true`                               | appcd-core                                 | Yes              | Ensures that the default plugins are installed in the appcd home directory. This operation requires both an Internet connection and write permissions to the appcd home directory. |
