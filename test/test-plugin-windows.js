...
describe('plugin windows', function () {
	...
	unsupportedIt('should register windows plugin as unsupported', makeTest(async function () {
		...
		expect(info).to.have.keys('activeRequests', 'apiVersion', 'appcdVersion', 'autoStart', 'dependencies', 'description', 'error', 'homepage', 'license', 'link', 'main', 'name', 'nodeVersion', 'os', 'packageName', 'path', 'supported', 'totalRequests', 'type', 'version');
